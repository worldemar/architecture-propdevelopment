...
![Диаграмма контейнеров C4](PropDevelopment_С4_model.drawio)
...
2. **Доработайте [диаграмму контейнеров PropDevelopment](PropDevelopment_С4_model.drawio).** Отразите на ней изменения, которые вы предлагаете сделать в ландшафте систем кампании в связи с внедрением новых бизнес-функций.
